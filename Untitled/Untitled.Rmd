...
title: shit
subtitle: more shit
full: "Enabling Patient Prioritization in the Montgomery County Emergency Room Overdose Notification (MC-ERON) System"
short: "PHDMC Internal Employee Satisfaction Survey Report Results"
abstract:     >
          This is where you put the abstract. Note chevron symbol above, it tells Pandoc 
          that this YAML entry spans multiple lines
keywords:     "awesome, ascend, amazing, other a-words"
...
knitcitations <- BIB[key = 'boettiger2017knitcitations']
refmanager    <- BIB[title = 'RefManageR']
pressure      <- BIB[key = 'randolph2016the']
...
For a detailed and in depth descriptions on how to make plots, and the different kinds that R is capable of creating, you can visit [this site](http://www.statmethods.net/graphs/scatterplot.html).
